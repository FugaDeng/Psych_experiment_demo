function RETtask_conceptual_practice
...
%from RETsetup_conceptual
tbl=readtable('retrievallist_c_practice.csv');
stimtbl=table;
stimtbl.pairID=tbl.pairID;
stimtbl.subset=tbl.subset;
stimtbl.Object=tbl.Object;
stimtbl.ObjectType=(tbl.subset==4);% 0: old objects; 1: new objects
...
imgI = imread(fullfile('instructionPics','RET_C_instruction_v2.jpg'));
...
for t = 1:pdata.nTrials    % loop through trials (38 trials per run)
    ...
    Screen(window1, 'FillRect', backgroundColor);
    DrawFormattedText(window1, stimtbl.Object{t},'center', H/2, textColor);%!!! REPLACE 'textstring'
    ...
    pdata.ObjectType{t}=stimtbl.ObjectType(t);
